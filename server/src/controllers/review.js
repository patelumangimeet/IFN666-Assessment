...
export const getAll = async (req, res) => {
  try {
    ...
    const links = {
      self: `/api/reviews?page=${page}&${queryString}`,
      next: page < totalPages ? `/api/reviews?page=${page + 1}&${queryString}` : null,
      prev: page > 1 ? `/api/reviews?page=${page - 1}&${queryString}` : null
    };
